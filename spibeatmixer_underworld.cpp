...
int main(int argc, char *argv[])
{
	...
	string wavfolder = "D:\\oifii-org\\httpdocs\\ha-org\\had\\dj-oifii\\raveaudio_wav\\dj-oifii_underworld";
		...
		if(pInstrumentSet && pInstrumentSet->HasOneInstrument()) 
		{
			...
			if(pAnInstrument2)
			{
				...
				//{
					...
					pSilentWavSet->SpreadSamples("0100010000100000", pAnInstrument2, loopduration_s, 10, 0.0); //pattern over loopduration_s sec, sample duration 5sec and with pattern offset of 0sec;// pAWavSet2
				//}
			}
